...
df <- read.csv("./us-counties.csv", header = TRUE, sep = ",")
...
table. Monroe County doesn't have any deaths yet...
...
Monroe County's COVID-19 has no deaths yet..

Next, we plot the curve.

```{r plotNewYork}
plt <- ggplot(mc_vals, aes(x=date, y=cases)) +
...
Sadly, Monroe County's curve has not flattened yet.
