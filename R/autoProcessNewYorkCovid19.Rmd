...
author: "John Minter"
date: "Started 2020-03-27, Last modified: 2020-04-01"
output:
  html_document:
...
```{r plotNewYorkDeaths}
plt <- ggplot(new_york, aes(x=date, y=deaths)) +
       geom_line(colour='darkred', size=2) +
       xlab("Date") +
       ylab("Total Cases") + 
       ggtitle("NY COVID-19 Deaths") +
       labs(caption = 'Data from Johns Hopkins') +
       scale_x_date() +
       # theme_minimal() +
       theme(axis.text=element_text(size=8),
...
plt_new <- ggplot(new_cases_tbl, aes(x=the_date, y=new_cases)) +
           geom_line(colour='darkred', size=2) +
           xlab("Date") +
           ylab("New Cases") + 
           ggtitle("NY COVID-19 Cases") +
