...
author: "John Minter"
date: 'Started 2020-03-27, Last modified: 2020-05-10'
output:
  html_document:
...
# fix for error on 05-06  can't be 25956 dashboard 20828 use that
# let's watch how changes work out...
# new_york$deaths[67]=20828
```

Note added 2020-05-07. The NYT data set showed a big spike on 2020-05-06 showed
a spike to 25956. The NY Dashboard from 05-07 shows 20828. has to be an error...
I manually entered that data point. Need to check with NYT.

The NYT explains:

> NEW: Starting with data for May 6th, this data reports the total combined
> number of confirmed and probable Covid-19 cases and deaths where available.
> Many states and localities have started to report this data using criteria
> that were developed by states and the federal government.

Let's see how this goes forward. I **do not like** the "probable cases" without
justification.
